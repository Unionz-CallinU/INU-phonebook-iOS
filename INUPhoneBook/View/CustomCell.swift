...
final class CustomCell: UITableViewCell {
  ...
  func layout() {
    ...
    email.topAnchor.constraint(equalTo: self.contentView.topAnchor, constant: 10).isActive = true
    ...
    phoneNum.topAnchor.constraint(equalTo: name.bottomAnchor, constant: 5).isActive = true
    ...
    // 셀 높이 조절
    let stackView = UIStackView(arrangedSubviews: [name, phoneNum, email])
